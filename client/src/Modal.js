...
function Modal({id}) {
  ...
  return (
    ...
    {id ? (
      ...
      <p className='modalp'>Internal Series Resistance</p>
      <LineChart width={350} height={200} data={data} margin={{ top: 0, right: 20, bottom: 0, left: 0 }}>
        <Line type='monotone' dataKey="internal_series_resistance" stroke="#8884d8"/>
